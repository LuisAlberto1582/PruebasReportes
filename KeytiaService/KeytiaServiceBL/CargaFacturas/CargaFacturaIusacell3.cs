...
Nombre:		    PGS
Fecha:		    20111207
Descripción:	Clase con la lógica for cargar las facturas de Iusacell Versión XML 3.
Modificación:	
*/
using System;
...
{
    public class CargaFacturaIusacell3 : CargaServicioFactura
    {
        ...
        public override void IniciarCarga()
        {
            ...
            else
            {
                ...
                pXmlns.AddNamespace("ns", "http://www.sat.gob.mx/cfd/3");
        ...
        protected override void ProcesarRegistro()
        {
            ...
            do
            {
                ...
                for (int liAtt = 0; liAtt < psaRegistro.Length; liAtt++)
                {
                    ...
                    if (psTpRegFac == "DetIusa" && !psaRegistro[liAtt].Contains("TFFO") && !psaRegistro[liAtt].Contains("NTELEF"))
                    {
                    ...
                    if (ValidarRegistro())
                    {
                        ...
                        else if (psTpRegFac == "DetIusa" && liNodeChild >= 3 && psaRegistro[liAtt].Split('|')[0].Split('_')[liNodeChild - 3] == "TFFO")
                        {
