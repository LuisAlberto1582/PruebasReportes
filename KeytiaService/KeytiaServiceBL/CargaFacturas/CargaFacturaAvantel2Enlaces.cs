...
{
    public class CargaFacturaAvantel2Enlaces : CargaServicioFactura
    {
        string psEnlace;
        string psFolio;
        int? piClaveCargo;
        ...
        public CargaFacturaAvantel2Enlaces()
        {
            pfrCSV = new FileReaderCSV();
            psSPResumenFacturasDeMoviles = "GeneraResumenFacturasDeMovilesAvantelEnl";
            psSPDetalleFacCDR = "GeneraDetalleFacturaCDRAvantelEnl";
        }

        public override void IniciarCarga()
        {
            ConstruirCarga("Avantel2", "Cargas Factura Avantel Enlaces", "Carrier", "Enlace");
            ...
            if ((((int)Util.IsDBNull(pdrConf["{BanderasCargaAvantelEnl}"], 0) & 0x01) / 0x01) == 1)
            {
        ...
        protected override void ProcesarRegistro()
        {
            ...
            try
            {
                ...
                if (psaRegistro[1].Trim().Length > 0)
                {
                    ...
                    GetClaveCargoAvantel(descripcion.Trim(), psTipo);
            ...
            {
                phtTablaEnvio.Clear();
                InsertarRegistroDet("DetalleFacturaA", psTpRegFac + "s", KDBAccess.ArrayToList(psaRegistro));
                return;
            }
        ...
        private void GetClaveCargoAvantel(string descClave, string descTipo)
        {
            ...
            lsb.AppendLine("AND TpSrvFac = (SELECT TOP(1) iCodCatalogo ");
