...
{
    public class CargaFacturaClaroElSalvador : CargaServicioFactura
    {
        ...
        public CargaFacturaClaroElSalvador()
        {
            pfrXLS = new FileReaderXLS();
            psSPDetalleFacCDR = "GeneraDetalleFacturaCDRClaroElSalvadorCel";
            psSPResumenFacturasDeMoviles = "GeneraResumenFacturasDeMovilesElSalvadorCel";
        ...
        public override void IniciarCarga()
        {
            ...
            //Los parámetros son: Carrier, Descripcion de la carga de factura, la palabra "Carrier" y la palabrea "Linea"
            ConstruirCarga("ClaroElSalvador", "Cargas Factura Claro El Salvador", "Carrier", "Linea");  
            ...
            for (int liArchivo = 1; liArchivo <= 1; liArchivo++) 
            {
            ...
            {
                //No se encontraron maestros para ClaroElSalvador
                ActualizarEstCarga("CarNoMae", psDescMaeCarga);
                return;
            }

            DataRow pdrClaveCargo = GetClaveCargo("ClaroElSalvador");
        ...
        protected override void ProcesarRegistro()
        {
            ...
            for (int liColReg = 0; liColReg < psaRegistro.Length; liColReg++)
            {
                ...
                if (ValidarRegistro())
                {
                    ...
                    if (psAtributo == "{NumeroTelf}")
                    {
                        ...
                        lsb.Append("and CarrierCod = 'ClaroElSalvadorCel' \r");
            ...
            foreach (DictionaryEntry ldeTablaEnvio in phtMaestrosEnvio)
            {
                ...
                psTpRegFac = "Cel";  //**RJ.Originalmente decía "Det"
                ...
                ldtHisCargas = kdb.ExecuteQuery("Detall","DetalleFacturaAClaroElSalvadorCel", "Select iCodRegistro From Detallados Where " +
                          "{Ident} = '" + lsIdent + "' and " +
        ...
        protected override void LlenarBDLocal()
        {
            ...
            ldtAuxMae = DSODataAccess.Execute("Select vchDescripcion from Maestros where vchDescripcion like 'DetalleFactura%ClaroElSalvador%' and dtIniVigencia <> dtFinVigencia order by vchDescripcion");
