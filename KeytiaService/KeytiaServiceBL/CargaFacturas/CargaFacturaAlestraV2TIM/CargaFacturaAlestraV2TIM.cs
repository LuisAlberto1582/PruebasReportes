...
{
    public class CargaFacturaAlestraV2TIM: CargaServicioFactura
    {
        protected StringBuilder query = new StringBuilder();
        protected List<FileInfo> archivos = new List<FileInfo>();
        protected List<TIMDetalleFacturaAlestraV2> listaDetalleFactura = new List<TIMDetalleFacturaAlestraV2>();
        ...
        public CargaFacturaAlestraV2TIM()
        {
        ...
        public virtual bool VaciarInfoDetalleFactura(int indexArchivo)
        {
            try
            {
                ...
                while ((psaRegistro = pfrXLS.SiguienteRegistro()) != null)
                {
                    ...
                    {
                        TIMDetalleFacturaAlestraV2 detall = new TIMDetalleFacturaAlestraV2();
        ...
        public virtual void InsertarDetalleFactura()
        {
            try
            {
                if (listaDetalleFactura.Count > 0)
                {
                    ...
                    foreach (TIMDetalleFacturaAlestraV2 item in listaDetalleFactura)
                    {
        ...
        {
            TIMDetalleFacturaAlestraV2 item = (TIMDetalleFacturaAlestraV2)listaDetalleFactura[0];
        ...
        private bool VerificarExisteCtaMaestra(List<TIMDetalleFacturaAlestraV2> listaDetalleFactura)
        {
            StringBuilder query = new StringBuilder();
            query.Append("Select * ");
