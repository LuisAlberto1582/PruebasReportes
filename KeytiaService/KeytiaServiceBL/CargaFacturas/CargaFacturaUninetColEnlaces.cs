...
{
    public class CargaFacturaUninetColEnlaces:CargaServicioFactura
    {
        ...
        public CargaFacturaUninetColEnlaces()
        {
            pfrCSV = new FileReaderCSV();
            psSPDetalleFacCDR = "GeneraDetalleFacturaCDRUninetCol";
            
            psSPResumenFacturasDeMoviles = "GeneraResumenFacturasDeMovilesUninetCol";
        }

        public override void IniciarCarga()
        {
            ConstruirCarga("UninetCol", "Cargas Factura Uninet COL", "Carrier", "Enlace");
        ...
        private int? GetClaveCarrier()
        {
            ...
            lsb.AppendLine("WHERE dtinivigencia <> dtfinvigencia AND dtfinvigencia >= GETDATE()");
            lsb.AppendLine("AND vchdescripcion='Uninet Colombia'");
