...
{
    public class CargaFacturaCyrus : CargaServicioFactura
    {
        ...
        public CargaFacturaCyrus()
        {
            pfrXLS = new FileReaderXLS();

            psSPDetalleFacCDR = "GeneraDetalleFacturaCDRCyrus";
            psSPResumenFacturasDeMoviles = "GeneraResumenFacturasDeMovilesCyrus";
        }

        public override void IniciarCarga()
        {
            ConstruirCarga("Cyrus", "Cargas Factura Cyrus", "Carrier", "Linea");
        ...
        protected override void ProcesarRegistro()
        {
            ...
            //NZ 20150720 Nuevo Layout
            phtTablaEnvio.Add("{PeriodoDate}", pdtPeriodo); //******
        ...
        private void ObtenerClavesCargoCarrier()
        {
            ...
            lsb2.Append("WHERE vchCodigo = 'CYRUS' AND dtIniVigencia <> dtFinVigencia AND dtFinVigencia >= getdate() \r");
