...
{
    public class CargaFacturaMovistarV3 : CargaServicioFactura
    {
        ...
        public CargaFacturaMovistarV3()
        {
            pfrXLS = new FileReaderXLS();

            psSPDetalleFacCDR = "GeneraDetalleFacturaCDRMovistarV3";
            psSPResumenFacturasDeMoviles = "GeneraResumenFacturasDeMovilesMovistarV3";

            //para pruebas.
            //psSPDetalleFacCDR = "  ";
            //psSPResumenFacturasDeMoviles = "   ";
        }

        public override void IniciarCarga()
        {
            ConstruirCarga("Movistar", "Cargas Factura MovistarV3", "Carrier", "Linea");
        ...
        protected override bool ValidarArchivo()
        {
            ...
            #region columnas anteriores

            //while (liRegsIni <= 1 && (psaRegistro = pfrXLS.SiguienteRegistro()) != null)
            //{
            //    //3 Registros de Encabezados previos al registro de Nombre de Columnas
            //    liRegsIni++;
            //}              


            //Validar nombres de las columnas en el archivo
            //if (!(psaRegistro[0].ToString().Trim() == "Empresa" &&
            //      psaRegistro[1].ToString().Trim() == "Telefono" &&
            //      psaRegistro[2].ToString().Trim() == "Dcto Renta Empresas Select 300" &&
            //      psaRegistro[3].ToString().Trim() == "Dcto Renta Empresas Select 600" &&
            //      psaRegistro[4].ToString().Trim() == "Dcto Renta Empresas Select 800" &&
            //      psaRegistro[5].ToString().Trim().Contains("Impuesto IEPS") &&
            //      psaRegistro[6].ToString().Trim().Contains("IVA") &&
            //      psaRegistro[7].ToString().Trim().Contains("Modulo 1GB") &&
            //      psaRegistro[8].ToString().Trim().Contains("Renta Empresas Select 300 VPN") &&
            //      psaRegistro[9].ToString().Trim().Contains("Renta Empresas Select 600 VPN") &&
            //      psaRegistro[10].ToString().Trim().Contains("Renta Empresas Select 800 VPN") &&
            //      //psaRegistro[11].ToString().Trim().Contains("RENTA TELEFONIA") &&
            //      psaRegistro[12].ToString().Trim().Contains("Grand Total")               
            //      )) 
            #endregion columnas anteriores
        ...
        private void ObtenerClavesCargoCarrier()
        {
            ...
            lsb.Append("WHERE vchCodigo='Movistar' AND dtIniVigencia <> dtFinVigencia AND dtFinVigencia >= getdate() \r");
            ...
            lsb2.Append("WHERE vchCodigo='Movistar' AND dtIniVigencia <> dtFinVigencia AND dtFinVigencia >= getdate() \r");
