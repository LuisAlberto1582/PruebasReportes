...
{
    public class CargaCDRAvayaBanorteCallC : CargaCDRAvayaBanorte
    {
        public CargaCDRAvayaBanorteCallC()
        {
            piColumnas = 15;
        ...
        protected override void ActualizarCampos()
        {
            ...
            //RJ.Corrige el número marcado, agrega u omite el prefijo que debe ser, 
            //de acuerdo a lo encontrado en el Plan de Numeración del INEGI
            psCDR[piDialedNumber] = AutoCorrigeTelDest(psClaveMarcacionLocali, ClearAll(psCDR[piDialedNumber].Trim()));
        }


        protected override bool ValidarGposTroncal(string lsTEntrada, string lsTSalida)
        {
            ...
            //Se pide que toda llamada que salga por la troncal 107 se asigne a un empleado en especifico
            if (lbTroncalesValidas && lsTSalida == "107")
            {
                ActualizaCodigoAutGpoTro();
            }
        ...
        /// <summary>
        /// En caso de que la troncal sea 107, se asignará el codigo para que a su vez
        /// la llamada se asigne a un empleado en especifico
        /// </summary>
        private void ActualizaCodigoAutGpoTro()
        {
            psCDR[piAuthCode] = "111111"; //Codigo asignado al empleado que se requiere
        }
    }
}
