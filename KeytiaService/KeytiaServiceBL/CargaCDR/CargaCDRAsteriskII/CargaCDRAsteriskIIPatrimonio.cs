...
{
    public class CargaCDRAsteriskIIPatrimonio : CargaCDRAsteriskII
    {
        ...
        protected override bool ValidarRegistro()
        {
            ...
            //ldtFecha = Util.IsDate(psCDR[5].Trim(), "yyyy-MM-dd HH:mm:ss");
        ...
        {
            /*RZ.20130416 Validaciones a nivel de cliente se mueven a nivel de sitio*/
