...
{
    public class CargaCDRAsteriskIProsaCAT16 : CargaCDRAsteriskI
    {
        ...
        public CargaCDRAsteriskIProsaCAT16()
        {
            ...
            //BG.20151117 Se invierten los campos
            //BG.20160104 Se dejan los campos como estaban originalmente (a solicitud IS)
            piBillSec = 12;
            piDuration = 13;
        ...
        /// <summary>
        /// Este método tiene fijo el sitio ProsaCat
        /// </summary>
        protected override void GetCriterios()
        {
            ...
            //SIEMPRE SE CONSIDERA COMO SITIO CAT, INDEPENDIENTEMENTE DE SU EXTENSION Y/O NUMMARCADO
            if (pSitioConf.Empre == piEmpresa && pSitioConf.VchCodigo.ToLower() == "prosacat")
            {
