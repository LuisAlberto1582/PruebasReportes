...
{
    public class CargaCDRAsteriskINYCE : CargaCDRAsteriskI
    {
        public CargaCDRAsteriskINYCE()
        {
            piColumnas = 25;
        ...
        protected override void GetCriterios()
        {
            ...
            if (lsExt.Length != lsExt2.Length)
            {
                ...
                lSitioLlamada = BuscaExtenEnRangosSitioComun<SitioAsteriskI>(pscSitioConf, lsExt, lsExt2, plstSitiosEmpre);
                if (lSitioLlamada != null)
                {
                    goto SetSitioxRango;
                }

                //Solo aplica si la carga automática está configurada para aceptar multiples sitios en el CDR
                if (pbCodAutEnMultiplesSitios)
                {
                    //Busca el sitio en los rangos de los sitios hijos
                    lSitioLlamada = BuscaExtenEnRangosSitioComun<SitioAsteriskI>(plstSitiosComunHijos, lsExt, lsExt2, plstSitiosHijos);
                    if (lSitioLlamada != null)
                    {
                        goto SetSitioxRango;
                    }
                ...
                lSitioLlamada = BuscaExtenEnRangosSitioComun<SitioAsteriskI>(plstSitiosComunEmpre, lsExt, lsExt2, plstSitiosEmpre);
                if (lSitioLlamada != null)
                {
                    goto SetSitioxRango;
                }
            ...
            else
            {
                ...
                //Busca el sitio en los rangos de extensiones del sitio base, utilizando primero el parámetro
                //de búsqueda 1 y luego el 2
                lSitioLlamada = BuscaExtenEnRangosSitioComun<SitioAsteriskI>(pscSitioConf, lsExt, plstSitiosEmpre);
                if (lSitioLlamada != null)
                {
                    goto SetSitioxRango;
                }
                ...
                {
                    //Busca el sitio en los rangos de los sitios hijos
                    lSitioLlamada = BuscaExtenEnRangosSitioComun<SitioAsteriskI>(plstSitiosComunHijos, lsExt, plstSitiosHijos);
                    if (lSitioLlamada != null)
                    {
                        goto SetSitioxRango;
                    }
                ...
                //Busca el sitio en los rangos de los sitios restantes (diferentes al sitio base)
                lSitioLlamada = BuscaExtenEnRangosSitioComun<SitioAsteriskI>(plstSitiosComunEmpre, lsExt, plstSitiosEmpre);
                if (lSitioLlamada != null)
                {
                    goto SetSitioxRango;
                }
        ...
        SetSitioxRango:
            ...
            List<GpoTroAsteriskI> llstGpoTroSitio =
        ...
        {
            return psCDR != null && psCDR[piDisposition] != null ? psCDR[piDisposition] : string.Empty ;
        }
    }
}
