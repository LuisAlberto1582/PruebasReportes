...
{
    public class CargaCDRAsteriskIFDelAhorro : CargaCDRAsteriskI
    {
        protected List<GpoTroAsteriskI> plstTroncales = new List<GpoTroAsteriskI>();

        public CargaCDRAsteriskIFDelAhorro()
        {
            piColumnas = 23;
        ...
        protected override bool ValidarRegistro()
        {
            ...
            if (psCDR[piAnswer].Trim() == "" || psCDR[piAnswer].Length != 19 || pdtFecha == DateTime.MinValue)
            {
                psMensajePendiente.Append("[piAnswer vacio, longitud <> 16 o formato fecha incorrecta]");
                lbValidaReg = false;
                return lbValidaReg;
            }
