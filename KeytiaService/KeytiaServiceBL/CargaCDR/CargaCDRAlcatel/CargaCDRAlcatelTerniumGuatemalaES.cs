...
{
    public class CargaCDRAlcatelTerniumGuatemalaES : CargaCDRAlcatelTernium
    {
        //RZ.20131219 Se baja metodo a nivel de clase sitio para agregar validaciones para cuando la llamada aplic  
