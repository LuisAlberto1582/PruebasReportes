...
{
    public class CargaCDRCiscoTerniumColombiaMedellin : CargaCDRCiscoTerniumColombia
    {
        public CargaCDRCiscoTerniumColombiaMedellin()
        {
            piColumnas = 112;
        ...
        #region Cambios para cambiar localidad en base a disas

        //20141201 AM. Se declara la variable disa 
        string lsDisa = string.Empty;
        ...
        protected override void AbrirArchivo()
        {
            ...
            if (pfrCSV.Abrir(psArchivo1))
            {
                ...
                else
                {
                    ...
                    DataTable ldtRelSitioDisa = DSODataAccess.Execute(consultaRelacionSitioDisas());
                        ...
                        try
                        {
                            ...
                            if (ValidarRegistro())
                            {
                                ...
                                if (pbEnviarDetalle == true)
                                {
                                    ...
                                    if (ldtRelSitioDisa.Rows.Count > 0)
                                    {
                                        CambiaLocalidadEnBaseADisa(ldtRelSitioDisa.Select("disa = " + lsDisa));
                                    }
        ...
        protected void CambiaLocalidadEnBaseADisa(DataRow[] disaSitio)
        {
            try
            {
                if (disaSitio.Length > 0)
                {
                    ...
                    string locali = DSODataAccess.ExecuteScalar(consultaLocalidad(sitio)).ToString();

                    if (locali.Length > 0 && locali != null)
                    {
                        phCDR["{Locali}"] = locali;
                    }
                }
        ...
        #endregion Cambios para cambiar localidad en base a disas
    }
}
