...
Nombre:		    DDCP
Fecha:		    20120403
Descripción:	Clase con la lógica standar para los conmutadores 3Com CSV - Cliente Cydsa
Modificación:
...
{
    public class CargaCDR3ComCSVCydsa : CargaCDR3ComCSV
    {
        public CargaCDR3ComCSVCydsa()
        {
        ...
        protected override bool ValidarRegistroSitio()
        {
            ...
            if (liAux >= 84000) // Duracion Incorrecta
            {
