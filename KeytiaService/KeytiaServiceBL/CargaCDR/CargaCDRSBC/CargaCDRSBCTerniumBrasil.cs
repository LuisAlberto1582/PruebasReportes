...
{
    public class CargaCDRSBCTerniumBrasil : CargaCDRSBCTernium
    {
        public CargaCDRSBCTerniumBrasil()
        {
            piColumnas = 8;
        ...
        SetSitioxRango:
            ...
            if ((lsDigitos.Length > 6 || lsDigitos.Length == 3) && lsExt.Length == 5)
            {
                piCriterio = 3;   // Salida
            }
            ...
            else if (lsExt.Length == 5 && lsDigitos.Length == 5)
            {
                piCriterio = 2;   // Enlace
            }
            else
