...
Nombre:		    DDCP
Fecha:		    20110829
Descripción:	Clase con la lógica para los conmutadores Avaya de Principal
Modificación:	
*/
using System;
...
{
    public class CargaCDRHarrisPrincipal : CargaCDRHarris
    {
        public CargaCDRHarrisPrincipal()
        {
            piColumnas = 30;
            piStrDate = 5;
            piAnsTime = 7;
