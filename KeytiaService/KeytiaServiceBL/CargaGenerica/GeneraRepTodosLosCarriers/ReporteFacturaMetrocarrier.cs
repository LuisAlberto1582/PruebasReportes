...
namespace KeytiaServiceBL.CargaGenerica.GeneraRepTodosLosCarriers
{
    public class ReporteFacturaMetrocarrier : ClaseGenericaReportePagos
    {
        ...
        public DataTable ObtieneInformacionComparacionCr()
        {
            ...
            query.AppendLine("exec PagosMetrocarrierObtieneData @esquema = '" + DSODataContext.Schema + "', ");
            query.AppendLine("@carrierDesc = 'MetroCarrier', ");
        ...
        public DataTable ObtieneInformacionComparacionCuenta()
        {
            ...
            StringBuilder query = new StringBuilder();
            query.AppendLine("exec PagosMetrocarrierObtieneDataConDiferencias @esquema = '" + DSODataContext.Schema + "', ");
            query.AppendLine("@carrierDesc = 'Banregio', ");
            query.AppendLine("@anioActual = {2}, ").Replace("{2}", AnioResultadoQuery.Rows[0][0].ToString());
            query.AppendLine("@mesActual = {3} ").Replace("{3}", MesResultadoQuery.Rows[0][0].ToString());
