    ...
    $.fn.dataTable = function(oInit) {
            ...
            if (iThs !== 0) {
                ...
                for (i = 0, iLen = oSettings.aoColumns.length; i < iLen; i++) {
                    ...
                    for (j = 1, jLen = anTr.length; j < jLen; j++) {
                        ...
                        if (!oSettings.aoColumns[i].bVisible && jqChildren[i - iCorrector] !== undefined) {
            ...
            */
            if (iColums == oHeaders.length && iUserInputs === 0 && iVisibleColumns == iColums &&
                ...
                */
                ...
                for (i = 0; i < iColums; i++) {
                    if (oSettings.aoColumns[i].bVisible) {
                        var nTd = _fnGetWidestNode(oSettings, i, false);
                        if (nTd !== null) {
        ...
        */
        function _fnSaveState(oSettings) {
            ...
            if (oSettings.oInit.$stateControl != undefined) {
                oSettings.oInit.$stateControl.val(sValue);
            }
            else {
        ...
        */
        function _fnLoadState(oSettings, oInit) {
            ...
            var oData, i, iLen;
            var sData;
            if (oInit.$stateControl !== undefined && oInit.$stateControl.val() !== "") {
                sData = oInit.$stateControl.val();
            }
            else {
                sData = _fnReadCookie(oSettings.sCookiePrefix + oSettings.sInstance);
            }
            if (sData !== null && sData !== '') {
